...
const _CombinedAffOrQuadExpr{C} = Union{CombinedAffExpr{C}, CombinedQuadExpr{C}}
...
function MA.promote_operation(::Union{typeof(+), typeof(-), typeof(*)},
                               ::Type{<:_Constant}, S::Type{<:_CombinedAffOrQuadExpr})
    return S
end
function MA.promote_operation(::Union{typeof(+), typeof(-), typeof(*)},
                               S::Type{<:_CombinedAffOrQuadExpr}, ::Type{<:_Constant})
    return S
end
function MA.promote_operation(
    ::Union{typeof(+), typeof(-)}, ::Type{<:Union{_Variable, _Decision}},
    S::Type{<:_CombinedAffOrQuadExpr})
    return S
end
function MA.promote_operation(
    ::Union{typeof(+), typeof(-)}, S::Type{<:_CombinedAffOrQuadExpr},
    ::Type{<:Union{_Variable, _Decision}})
    return S
end
function MA.promote_operation(
    ::Union{typeof(+), typeof(-)}, ::Type{GenericAffExpr{C,V}},
    S::Type{_CombinedAffOrQuadExpr{C}}) where {C, V <: Union{_Variable, _Decision}}
    return S
end
function MA.promote_operation(
    ::Union{typeof(+), typeof(-)}, S::Type{_CombinedAffOrQuadExpr{C}},
...
function MA.promote_operation(::Union{typeof(+), typeof(-)}, ::Type{A},
                               ::Type{A}) where {A <: _CombinedAffOrQuadExpr}
    return A
end
function MA.promote_operation(::Union{typeof(+), typeof(-)},
                               ::Type{<:CombinedAffExpr},
                               S::Type{<:CombinedQuadExpr})
    return S
end
function MA.promote_operation(::Union{typeof(+), typeof(-)},
                               S::Type{<:CombinedQuadExpr},
...
function MA.promote_operation(::typeof(*), ::Type{V}, ::Type{CombinedAffExpr{T}}) where {T, V <: Union{_Variable, _Decision}}
    return CombinedQuadExpr{T}
end
function MA.promote_operation(::typeof(*), ::Type{CombinedAffExpr{T}}, ::Type{V}) where {T, V <: Union{_Variable, _Decision}}
    return CombinedQuadExpr{T}
end

function MA.scaling(aff::CombinedAffExpr{C}) where C
...
function MA.scaling(quad::CombinedQuadExpr{C}) where C
...
MA.mutability(::Type{<:_CombinedAffOrQuadExpr}) = MA.IsMutable()
function MA.mutable_copy(expr::_CombinedAffOrQuadExpr)
    return map_coefficients(MA.copy_if_mutable, expr)
end

function MA.mutable_operate!(op::Union{typeof(zero), typeof(one)}, aff::CombinedAffExpr)
    MA.mutable_operate!(op, aff.variables)
    MA.mutable_operate!(zerl, aff.decisions)
    MA.mutable_operate!(zero, aff.knowns)
    return aff
end
function MA.mutable_operate!(op::Union{typeof(zero), typeof(one)}, quad::CombinedQuadExpr)
...
function MA.mutable_operate!(::typeof(*), expr::_CombinedAffOrQuadExpr, α::_Constant)
    if iszero(α)
...
function MA.mutable_operate!(::typeof(+), expr::_CombinedAffOrQuadExpr, x)
...
function MA.mutable_operate!(::typeof(MA.add_mul), expr::_CombinedAffOrQuadExpr, x::_Scalar)
    return JuMP.add_to_expression!(expr, x)
end
function MA.mutable_operate!(::typeof(MA.add_mul), expr::_CombinedAffOrQuadExpr, x::_Scalar, y::_Scalar)
    return JuMP.add_to_expression!(expr, x, y)
end
function MA.mutable_operate!(::typeof(MA.sub_mul), expr::_CombinedAffOrQuadExpr, x::_Scalar)
    return JuMP.add_to_expression!(expr, -1.0, x)
end
function MA.mutable_operate!(::typeof(MA.sub_mul), expr::_CombinedAffOrQuadExpr, x::_Scalar, y::_Scalar)
    return JuMP.add_to_expression!(expr, -x, y)
end
function MA.mutable_operate!(::typeof(MA.sub_mul), expr::_CombinedAffOrQuadExpr, x::Union{_Variable, _Decision}, y::_Constant)
    return JuMP.add_to_expression!(expr, x, -y)
end
function MA.mutable_operate!(op::MA.AddSubMul, expr::_CombinedAffOrQuadExpr, x, y)
    return MA.mutable_operate!(op, expr, x * y)
end
@generated function _add_sub_mul_reorder!(op::MA.AddSubMul, expr::_CombinedAffOrQuadExpr, args::Vararg{Any, N}) where N
    n = length(args)
    @assert n ≥ 3
...
function MA.mutable_operate!(op::MA.AddSubMul, expr::_CombinedAffOrQuadExpr, x, y, z, other_args::Vararg{Any, N}) where N
    return _add_sub_mul_reorder!(op, expr, x, y, z, other_args...)
end
function JuMP.add_to_expression!(expr::_CombinedAffOrQuadExpr, α::_Constant, β::_Constant)
